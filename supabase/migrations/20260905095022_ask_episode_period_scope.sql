-- Apply period before discovery limits; retain pinned identity revalidation.
begin;
drop function public.read_ask_episode_sources(uuid,text[],uuid[]);
create function public.read_ask_episode_sources(p_pet_id uuid,p_keys text[],p_episode_ids uuid[] default null,p_from timestamptz default null,p_to timestamptz default null)
