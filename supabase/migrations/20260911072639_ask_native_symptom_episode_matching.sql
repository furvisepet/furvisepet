...
declare
  ...
  old_predicate text := $old$episode_row.normalized_key = v_key$old$;
  new_predicate text := $new$(episode_row.normalized_key = v_key or (v_domain = 'health' and episode_row.episode_type = 'symptom' and episode_row.normalized_key = v_topic and coalesce(episode_row.summary->>'semanticDomain', 'health') = 'health'))$new$;
begin
