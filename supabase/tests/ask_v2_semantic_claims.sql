  ...
  v_payload jsonb := jsonb_build_object(
    'claims', jsonb_build_array(
      jsonb_build_object(
        ...
        'claim_kind', 'event', 'canonical_concept_key', 'limping', 'concept_version', 'concept.v1',
      ...
      jsonb_build_object(
        ...
        'claim_kind', 'preference', 'canonical_concept_key', 'retailer_locality', 'concept_version', 'concept.v1',
