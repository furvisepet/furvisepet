...
for(const [from,to] of [['react/jsx-runtime',import.meta.resolve('react/jsx-runtime')],['../lib/ask-text-blocks',new URL('../app/lib/ask-text-blocks.ts',import.meta.url).href],['../lib/plain-table',new URL('../app/lib/plain-table.ts',import.meta.url).href]])js=js.replaceAll(JSON.stringify(from),JSON.stringify(to));
