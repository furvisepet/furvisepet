...
const HOMEPAGE_STORY_ART = {
  cat: { height: 1536, sizes: "(min-width: 1560px) 690px, (min-width: 1024px) 42vw, 92vw", src: "/images/cat.png", width: 1024 },
  deer: { height: 1536, sizes: "(min-width: 1560px) 720px, (min-width: 1024px) 44vw, 92vw", src: "/images/deer.png", width: 1024 },
  hummingbird: { height: 1024, sizes: "(min-width: 1560px) 610px, (min-width: 1024px) 38vw, 92vw", src: "/images/hummingbird.png", width: 1536 },
} as const;
    ...
    <section className="homepage-story-chapter homepage-story-hero" data-chapter="why-we-exist" data-pace="full">
      <div className="homepage-wide-shell homepage-story-inner">
        ...
        <div aria-hidden="true" className="homepage-story-art homepage-hero-art homepage-art-heron" data-art="heron">
          <Image alt="" aria-hidden="true" className="homepage-story-art-image" fill priority sizes="(min-width: 1560px) 800px, (min-width: 1200px) 50vw, (min-width: 1024px) 44vw, 92vw" src="/images/heron.png" />
        </div>
      </div>
    </section>
  );
