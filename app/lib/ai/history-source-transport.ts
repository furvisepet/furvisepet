...
export function compactHistorySourceCoverage(sources: EvidenceSource[], represented: Set<string>) {
  ...
  type Member = Pick<EvidenceSource, "source" | "loadedCount" | "cap">;
  type Group = Omit<EvidenceSource, "source" | "loadedCount" | "cap"> & { members: Member[] };
