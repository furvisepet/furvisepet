...
const acknowledgementPattern = /^(?:(?:thanks?(?: you)?(?: a lot| so much)?|thank you(?: so much)?|ty|thx)(?:[,! .]+(?:that helps|that helped|that clears it up|that makes sense|appreciate it|so much))?|okay|ok|yes|no|got it|sounds good|understood)[.!\s]*$/i;
