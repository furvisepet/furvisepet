...
const acknowledgementPattern = /^(?:(?:thanks?(?: you)?|thank you|ty|thx)(?:[,! .]+(?:that helps|that helped|appreciate it|so much))?|okay|ok|yes|no|got it|sounds good|understood)[.!\s]*$/i;
