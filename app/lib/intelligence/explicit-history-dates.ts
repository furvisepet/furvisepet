...
export function explicitHistoryDays(question: string, year: number): string[] {
 ...
 if(!Number.isInteger(year)||year<1900||year>2099||matches.length<1||matches.length>2) return [];
