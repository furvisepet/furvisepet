...
export type SemanticStateValue = StateDomainValue & { domain: string; topic: string; transition: string; importance: "routine" | "important" | "urgent"; episodeId: string | null };
export type CanonicalPetState = { wellbeing?: { overall: "normal" | "uncertain" | "monitoring" | "concerning" | "urgent" }; breathing?: StateDomainValue; energy?: StateDomainValue; appetite?: StateDomainValue; currentFood?: StateDomainValue; currentMedications?: Array<{ name: string; startedAt: string; sourceEventId: string }>; semanticStates?: Record<string, SemanticStateValue>; lastMeaningfulUpdateAt?: string };
