...
const modes = {
  ...
  vet_brief: mode("vet_brief", "vet_brief", intelligenceVetBriefJsonSchema, "furvise_vet_brief", {
    ...
    instructions: [
      ...
      "Include one to three useful questions to discuss with the veterinarian. These are new discussion prompts, not claims that the owner previously asked them, so do not require recorded questions. Questions must not embed unsupported diagnoses or facts. Retrospective summaries need no questions.",
