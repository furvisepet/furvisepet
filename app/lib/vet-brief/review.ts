...
export const vetBriefReviewSchema = {
  ...
  required: ["factsSupported", "importantHistoryPreserved", "categoriesAccurate", "uncertaintyPreserved", "noDuplication", "questionsUseful"],
  properties: {
    ...
    noDuplication: { type: "boolean" }, questionsUseful: { type: "boolean" },
  },
} as const;
