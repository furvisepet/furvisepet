...
export type AuthFlow = "signup" | "login" | "login_otp_start" | "account_route" | "password_recovery" | "confirmation_resend" | "email_otp_verify" | "oauth_initiation" | "account_password_change";
