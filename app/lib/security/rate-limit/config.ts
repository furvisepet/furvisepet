...
const DEFAULT_POLICIES: Record<RateLimitPolicyName, RateLimitPolicy> = {
  ...
  ACCOUNT_PASSWORD_CHANGE: {
    ...
    user: { limit: 5, windowMs: 15 * MINUTE },
  },
  AUTH_SIGNUP: authPolicy("AUTH_SIGNUP", 5, 15 * MINUTE, 3, HOUR, 20),
  AUTH_LOGIN: authPolicy("AUTH_LOGIN", 20, 15 * MINUTE, 10, 15 * MINUTE, 80),
  AUTH_LOGIN_OTP_START: authPolicy("AUTH_LOGIN_OTP_START", 10, 10 * MINUTE, 3, 10 * MINUTE, 40),
  AUTH_ACCOUNT_ROUTE: authPolicy("AUTH_ACCOUNT_ROUTE", 10, 10 * MINUTE, 3, 10 * MINUTE, 40),
  ...
  AUTH_CONFIRMATION_VERIFY: authPolicy("AUTH_CONFIRMATION_VERIFY", 20, 10 * MINUTE, 6, 10 * MINUTE, 100),
