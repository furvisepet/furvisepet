...
for (const selection of ['reference','period']) test(`undated ${selection} selection preserves validated scope without inventing dates`, async t => {
  clock(t);
  ...
  assert.equal(r.context.askInterpretation.selection,selection);
