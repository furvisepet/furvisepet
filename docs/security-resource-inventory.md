...
- Public assets (profile ASSET): `/android-192.png`, `/android-512.png`, `/App icon.png`, `/apple-touch-icon.png`, `/brand/furvise-heron.svg`, `/brand/furvise-logo.svg`, `/brand/furvise-wordmark.svg`, `/favicon.ico`, `/favicon-16.png`, `/favicon-32.png`, `/furvise.ico`, `/images/cat.png`, `/images/dog.png`, `/manifest.webmanifest`, `/maskable-icon-512.png`. Untracked local QA screenshots are not deployed by Next.js.
